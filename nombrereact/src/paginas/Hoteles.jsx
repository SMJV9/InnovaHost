...
const Hoteles = () => {
    ...
    const manejarReserva = (hotel) => {
        if (!isAuthenticated()) {
            ...
            // Si está logueado, redirigir al detalle del hotel
    ...
    if (cargando && hoteles.length === 0) {
        return (
            <div className="min-h-screen bg-gray-50">
                <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16" style={{
