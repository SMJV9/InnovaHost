...
const PerfilCliente = () => {
    ...
    usePageTitle('Mi Perfil - InnovaHost');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/cliente/profile`, {
                method: 'PUT',
                headers: {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">Debes iniciar sesión como cliente para acceder a esta página</p>
                    <button 
            ...
            <div className="max-w-2xl mx-auto px-4">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Mi Perfil de Cliente</h1>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium">#{user.id_cliente}</p>
                        </div>
                        <div>
